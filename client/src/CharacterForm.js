...
function CharacterForm() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        console.log(data)
        const res = await axio.post('http://localhost:5000/new',{
                ...
                <div className='row'>
                    <div className='module' id='basic-info'>
                        ...
                        <div className='line'>
                            <label>
                                性别:
                                <select onChange={handleChangeGender} defaultValue ={''}>
                    ...
                    <div className='module' id='appearence'>
                        ...
                        <div className='line'>
                            <div id='apperence-basic-info'>
                                ...
                                <label>
                                    体型:
                                    <select onChange={handleChangeFigure} defaultValue ={''}>
                                        <option value='' disabled>未选择</option>
                    ...
                    <div className='module' id='belongings'>
                        ...
                        <div className='line'>
                            <div className='alt-add-box' id='belongings-container'>
                                <label>
                                    财富状况:
                                    <select onChange={onWealthChange} defaultValue ={''}>
                                        <option value='' disabled>未选择</option>
